""" Board configuration module for the MaixDuino.
"""
import time
import tbot
...
class MyBoard(
    ...
    """ Board definition for the MaixDuino.
    """
...
class MyUBootBuilder(tbot.tc.uboot.UBootBuilder):
    """ Builder for the MaixDuino.
    """
    name = "maixduino"
    defconfig = "sipeed_maix_smode_defconfig"
    toolchain = "riscv64"
...
class MyBoardUBoot(
    ...
    """ U-Boot testing for the MaixDuino.
    """
    prompt = "=> "
...
class MyLinux(
    ...
    """ Linux testing for the MaixDuino.
    """
    cred = MyCredentials()
    username = cred.get_username("maixduino")
    password = cred.get_password("maixduino")
    cred = None
